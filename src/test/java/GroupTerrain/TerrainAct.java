...
public class TerrainAct {
	...
	@When("^user enter valid data on the page$") public void enter_data_Reg(DataTable table) throws Throwable {

		List<List<String>> data=table.raw(); Select drpCountry = new Select(driver.findElement(By.id("user_title")));
	...
	@Then("^the user registration should be successful$") public void success_Reg() throws Throwable { driver.getTitle().contains("Title");
	...
	@When("^User enters valid details$") public void enter_data(DataTable tables)
			throws Throwable {
	...
	@When("^user enters valid data details on the page$") public void enter_Data(DataTable table) throws Throwable{
